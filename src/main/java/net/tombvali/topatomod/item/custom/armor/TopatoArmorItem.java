...
public abstract class TopatoArmorItem extends ArmorItem {
    public TopatoArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties builder) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                ...
                return (HumanoidModel<?>) GeoArmorRenderer.getRenderer(TopatoArmorItem.this.getClass(), livingEntity)
